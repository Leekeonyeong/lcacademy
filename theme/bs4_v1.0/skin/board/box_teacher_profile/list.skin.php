        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="<?php echo $style ?>width:<?php echo $board['bo_gallery_width'] ?>px">
            ...
            <ul class="gall_con">
                <li class="gall_href">
                    ...
                    <?php } else {
                        $thumb = get_list_thumbnail($board['bo_table'], $list[$i]['wr_id'], '120px', '130px');

                        if($thumb['src']) {
                            $img_content = '<img src="'.$thumb['src'].'" alt="'.$thumb['alt'].'" width="100px" height="130px" style="border:1px solid #ddd;">';
                        } else {
                            $img_content =  "<img src='".$board_skin_url."/img/no_image.png' align='absmiddle' border='0'>";	//NO_IMAGE 출력
                        }
						echo "<div style='width:130px;height:120px;float:left;'>";
                        echo $img_content;
						echo "</div>";
                    }
                     ?>
                ...
                <li class="gall_text_href" style="width:<?php echo $board['bo_gallery_width'] ?>px;">
                    <a href="<?php echo $list[$i]['href'] ?>" class="add_title">
                        <?php echo $list[$i]['subject'] ?>
                    </a> <?php echo $list[$i]['wr_1'] ?>
					<?php
                    ...
                    <a href="<?php echo $list[$i]['ca_name_href'] ?>" class="bo_cate_link" style="font-size:11px;font-weight:normal;"><?php echo $list[$i]['ca_name'] ?></a></br>
                    <?php } ?>
					 <br>
					 <p style="line-height:160%;"><a href="<?php echo $list[$i]['href'] ?>"><?php echo $list[$i]['wr_3'] ?></a><br>
					 Tel : <a href="<?php echo $list[$i]['href'] ?>"><?php echo $list[$i]['wr_4'] ?></a><br>
					 Fax : <a href="<?php echo $list[$i]['href'] ?>"><?php echo $list[$i]['wr_5'] ?></a><br>
					 E-mail : <a href="<?php echo $list[$i]['href'] ?>"><?php echo $list[$i]['wr_6'] ?></a></p>
					...
					echo '<div style="display:block;overflow:hidden;padding-top:1.000em;height:20px;line-height:1.500em;border-top:1px solid #ddd;">';
					echo nl2br($wr_content);
					echo '</div>';

                     ?>
                </li>
				<a href="<?php echo $list[$i]['href'] ?>"><li class="pr_btn" style="margin:0 0 0 105px">프로필 보기</li></a>

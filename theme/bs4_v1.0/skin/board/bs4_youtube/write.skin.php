...
<section id="bo_w">
    ...
    <!-- 유튜브 동영상 시작 { -->
    <div class="form-group label-floating">
	    <label class="control-label" for="youtube">유튜브주소</label>
        <input type="text" class="form-control" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" placehold="입력예 : https://youtu.be/0wlXaHmmOVc">
	</div>
    <!-- } 유튜브 동영상 끝 -->

...
?>
	<H4 class="pull-right">
		<i class="fa fa-fw fa-check-square-o"></i> 필수입력항목
	</H4>
...
<section id="bo_w">
    ...
    <?php if ($option) { ?>
		<tr><td>
			<div class="write_div">
				<label for="wr_subject" class="col-sm-2 control-label text-center">옵션</label>
				<div class="col-sm-10">
					<?php echo $option ?>
				</div><!-- col-sm-10 -->
   ...
   <div class="bo_w_select write_div">
        <label for="ca_name"  class="col-sm-2 control-label text-center"><i class="fa fa-fw fa-check-square-o"></i> 분류</label>
  ...
  <?php } ?>
    ...
    <div class="bo_w_tit write_div">
        <label for="wr_subject" class="col-sm-2 control-label text-center"><i class="fa fa-fw fa-check-square-o"></i> 제목</label>
		<div class="col-sm-10">
				<input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required form-control" size="50" maxlength="255" placeholder="제목">
 		...
 		<tr><td>
   <div class="write_div">
        <label for="wr_content" class="col-sm-2 control-label text-center"><i class="fa fa-fw fa-check-square-o"></i> 내용</label>
  		<div class="col-sm-10">
   ...
   <div class="bo_w_link write_div">
        <label class="col-sm-2 control-label text-center" for="wr_link1"><i class="fa fa-link" aria-hidden="true"></i> 유튜브주소</label>
  		<div class="col-sm-10">
			<input type="text" name="wr_link1" value="<?php echo $write['wr_link1'] ?>" id="wr_link1" class="frm_input full_input form-control" size="50" placeholder="http://www.youtube.com/watch?v=9bZkp7q19f0…" onkeyup="getvidID(this.value);">
	    </div><!-- col-sm-10 -->
    </div>
	</td></tr>
 		...
 		<tr><td>
   <div class="bo_w_link write_div">
        <label class="col-sm-2 control-label text-center" for="wr_link2"><i class="fa fa-link" aria-hidden="true"></i> 유튜브 썸네일</label>
  		<div class="col-sm-10">
			<input type="text" name="wr_link2" value="<?php echo $write['wr_link2'] ?>" id="wr_link2" class="frm_input full_input form-control" size="50" readonly>
	    </div><!-- col-sm-10 -->
    </div>
	</td></tr>
   ...
   <div class="bo_w_flie write_div">
        <div class="file_wr write_div">
            <label for="bf_file_<?php echo $i+1 ?>" class="lb_icon col-sm-2 control-label text-center"><i class="fa fa-download" aria-hidden="true"></i> 파일 #<?php echo $i+1 ?></label>
			<div class="col-sm-10">

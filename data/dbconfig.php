...
define('G5_MYSQL_HOST', 'db.lcaadmin.gabia.io');
define('G5_MYSQL_USER', 'lcaadmin');
define('G5_MYSQL_PASSWORD', '1q2w3e4r5t!');
define('G5_MYSQL_DB', 'dblcaadmin');
define('G5_MYSQL_SET_MODE', false);

define('G5_TABLE_PREFIX', 'lca_');
